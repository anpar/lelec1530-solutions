...
\begin{enumerate}
	...
	\[ I = \frac{\SI{5}{\volt}-V_{D1}}{\SI{270}{\kilo\ohm}} = k_n(V_{GS1} - 1)^2 = k_n(V_{D1} - 1)^2.\]	
	On obtient
	\[ V_{D1} = \SI{2.29}{\volt} \]
	et
	\[ I = \SI{10.04}{\micro\ampere}. \]
	
	\item Les transistors Q1 et Q2 sont montés en miroir de courant, le courant dans la branche
	de droite est donc égal au courant dans le branche de gauche.
	\item 
